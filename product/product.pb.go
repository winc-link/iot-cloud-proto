...
type Typespec struct {
	...
	Maxlen       string   `protobuf:"bytes,7,opt,name=maxlen,proto3" json:"maxlen,omitempty"`
	Maxsize      string   `protobuf:"bytes,8,opt,name=maxsize,proto3" json:"maxsize,omitempty"`
