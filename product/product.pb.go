...
const (
	ProductNodeType_GATEWAY ProductNodeType = 0
	ProductNodeType_Device  ProductNodeType = 1
	ProductNodeType_Other   ProductNodeType = 2
)
...
func (x *QueryProductListResponse_Productinfo) GetNodeType() ProductNodeType {
	...
	return ProductNodeType_GATEWAY
}
...
var file_product_product_proto_rawDesc = []byte{
	...
	0x35, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x47, 0x41, 0x54, 0x45, 0x57, 0x41, 0x59, 0x10, 0x00, 0x12,
	0x0a, 0x0a, 0x06, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x4f,
	0x74, 0x68, 0x65, 0x72, 0x10, 0x02, 0x32, 0x67, 0x0a, 0x0a, 0x52, 0x70, 0x63, 0x50, 0x72, 0x6f,
...
var file_product_product_proto_goTypes = []interface{}{
	...
	(*QueryProductListRequest)(nil),  // 1: product.QueryProductListRequest
	(*QueryProductListResponse)(nil), // 2: product.QueryProductListResponse
	nil,                              // 3: product.QueryProductListRequest.ExtraEntry
	(*QueryProductListResponse_Productinfo)(nil), // 4: product.QueryProductListResponse.Productinfo
	(*QueryProductListResponse_List)(nil),        // 5: product.QueryProductListResponse.List
	(*QueryProductListResponse_Data)(nil),        // 6: product.QueryProductListResponse.Data
	nil,                                          // 7: product.QueryProductListResponse.Productinfo.ExtraEntry
}
var file_product_product_proto_depIdxs = []int32{
	3, // 0: product.QueryProductListRequest.extra:type_name -> product.QueryProductListRequest.ExtraEntry
	6, // 1: product.QueryProductListResponse.data:type_name -> product.QueryProductListResponse.Data
	0, // 2: product.QueryProductListResponse.Productinfo.NodeType:type_name -> product.ProductNodeType
	7, // 3: product.QueryProductListResponse.Productinfo.extra:type_name -> product.QueryProductListResponse.Productinfo.ExtraEntry
	4, // 4: product.QueryProductListResponse.List.ProductInfo:type_name -> product.QueryProductListResponse.Productinfo
	5, // 5: product.QueryProductListResponse.Data.List:type_name -> product.QueryProductListResponse.List
	1, // 6: product.RpcProduct.QueryProductList:input_type -> product.QueryProductListRequest
	2, // 7: product.RpcProduct.QueryProductList:output_type -> product.QueryProductListResponse
